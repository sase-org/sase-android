...
class MobileApiContractTest {
    ...
    private companion object {
        val EXPECTED_ROUTES = listOf(
            ...
            ExpectedRoute("GET /api/v1/session/push-subscriptions", "PushSubscriptionListResponseWire", true),
            ExpectedRoute("POST /api/v1/session/push-subscriptions", "PushSubscriptionRegisterResponseWire", true),
            ExpectedRoute("DELETE /api/v1/session/push-subscriptions/{id}", "PushSubscriptionDeleteResponseWire", true),
